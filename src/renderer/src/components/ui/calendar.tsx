...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn('p-3 bg-popover text-popover-foreground rounded-2xl border border-border/40 shadow-md', className)}
      classNames={{
        ...
        day_button: cn(
          ...
          'h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-accent hover:text-accent-foreground rounded-lg'
        ),
        range_end: 'range_end',
        selected: 'bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground',
        today: 'bg-accent text-accent-foreground',
        outside: 'outside text-muted-foreground aria-selected:bg-accent/50 aria-selected:text-muted-foreground aria-selected:opacity-30',
